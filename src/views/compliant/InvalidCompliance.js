...
import InvalidComplianceTable from "./components/InvalidComplianceTable.js";
import { useGetEmployeeCompliantRequestsQuery , useGetAllInValidCompliantsQuery} from "store/services";
...
const InvalidCompliance = () => {
  ...
  const { data, error, isLoading } = useGetAllInValidCompliantsQuery();
...
export default  InvalidCompliance;
