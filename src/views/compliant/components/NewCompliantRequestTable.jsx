                    ...
                    if (cell.column.Header == "የቅሬታ እርስ") {
                      ...
                      data = (
                        <div className="flex items-center gap-1">
                          ...
                          <p className="text-sm font-bold text-navy-700 dark:text-white">
                          <Link to={`/admin/compliant-detail/${cell.value}`} className="text-md md:text-lg text-navy bg-navy-600 hover:bg-navy-700 text-white font-semibold py-2 px-1 rounded">
                          መልስ 
          </Link>
                          </p>
                        </div>
